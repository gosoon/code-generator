...
func (c *namespace) getNamespace(w http.ResponseWriter, r *http.Request) {
	...
	controller.OK(w, r, namespaceObj)
}
...
func (c *namespace) deleteNamespace(w http.ResponseWriter, r *http.Request) {
	...
	// get object
	namespaceObj, err = c.opt.Service.GetNamespace(r.Context(), namespaceObj.Name)
	if err != nil {
		controller.BadRequest(w, r, err)
		return
	}
	...
	// delete object
	err = c.opt.Service.DeleteNamespace(r.Context(), namespaceObj.Name)
	if err != nil {
		controller.BadRequest(w, r, err)
		return
	}
